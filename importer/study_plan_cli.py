...
from importer.study_plan_importer import read_program_urls, run_study_plan_import


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Import official DTU study plans")
    source = parser.add_mutually_exclusive_group(required=True)
    source.add_argument("--url", help="Import one public DTU study-plan URL")
...
def main() -> None:
    ...
    urls = [args.url] if args.url else read_program_urls(args.urls_file)
